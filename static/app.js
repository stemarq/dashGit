...
/** Dia que nao conta inteiro — fim de semana ou feriado —, no fuso de quem
 *  olha, igual ao servidor. */
function isOffDay(data) {
  if (state.skipWeekends && (data.getDay() === 0 || data.getDay() === 6)) return true;
